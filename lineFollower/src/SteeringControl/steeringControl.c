...
void initServoControl() {
	//TODO : switch to TIM 3 Ch 4 (PC9)
	//Init for servo control on pin PB3 (TIM3 ch2)
	...
	TIM3->ARR = 20000-1;
	TIM3->CCR4 = 20000 - 1500 - 1; // CCR2 timer (for servo this determines angle (1-2 ms pulse width))
	TIM3->CCMR2 |= TIM_CCMR2_OC4M_0;
	TIM3->CCMR2 |= TIM_CCMR2_OC4M_1; //sets CCMR1 to mode 2... 111
